...
#define PORTB_PIN4_INITVAL  fLOATAING
#define PORTB_PIN5_INITVAL  fLOATAING
#define PORTB_PIN6_INITVAL  fLOATAING
#define PORTB_PIN7_INITVAL  fLOATAING

#define PORTC_PIN0_INITVAL  LOW
#define PORTC_PIN1_INITVAL  LOW
#define PORTC_PIN2_INITVAL  fLOATAING
#define PORTC_PIN3_INITVAL  fLOATAING
#define PORTC_PIN4_INITVAL  fLOATAING
...
#define PORTD_PIN2_INITVAL  fLOATAING
#define PORTD_PIN3_INITVAL  fLOATAING
#define PORTD_PIN4_INITVAL  fLOATAING
#define PORTD_PIN5_INITVAL  fLOATAING
